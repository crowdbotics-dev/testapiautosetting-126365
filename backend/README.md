...
## Project Structure
    ...
    ├── testapiautosetting_126365  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126365`
...
2. Clone this repo and `cd testapiautosetting_126365`
